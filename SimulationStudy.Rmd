...
This is a R markdown document provides the simulation study of the method described in **Tuning-free ridge estimators for high-dimensional generalized linear models** by Shih-Ting Huang, Fang Xie, and Johannes Lederer.
...
Some additional functions are loaded below and the description of each function can be found in the folder named **Additional functions**.
